...
'    <li class="active btn-subir"><a href="#"><span class="glyphicon glyphicon-plus"></span> Sube tu caso  </a> </li>',
'    <li class="dropdown">',
...
'</div>'
  ...
  Templates['contacts'] =  [
    '',
          '<ul class="media-list contacts-container"></ul>'
  ].join('');
                      ...
                      '</div>',
    								 ...
    								 '<div class="panel-body">',
    									...
    									'<p class="show-image" ><a href="#">',
                                         '<img class="imgcenter" src="images/{{image}}.jpg" /> </a>',
